...
class parentalVerificationScreen extends StatefulWidget {
  const parentalVerificationScreen({super.key});

  @override
  State<parentalVerificationScreen> createState() => _parentalVerificationScreenState();
}

class _parentalVerificationScreenState extends State<parentalVerificationScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                ...
                hint: "input your email parent's here",
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Get.toNamed(AppRoutes.successParentalVerification);
                  },
                  child: const Text(
                    'SEND VERIFICATION',
                    style: TextStyle(
